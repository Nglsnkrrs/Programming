...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->главнаяToolStripMenuItem->Click += gcnew System::EventHandler(this, &TestForm::главнаяToolStripMenuItem_Click);
			// 
			...
			this->panel_Profile->Click += gcnew System::EventHandler(this, &TestForm::мойПрофильToolStripMenuItem_Click);
			// 
			// labelResultTests
			// 
...
#pragma endregion
	...
	private: 
		...
		System::Void главнаяToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e);
